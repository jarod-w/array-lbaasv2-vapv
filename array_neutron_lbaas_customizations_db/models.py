...
class ArrayLbaasTenantCustomizations(BaseTable):

    __bind_key__ = "arraylbaastenantcust"
    __tablename__ = "array_lbaas_tenant_customizations"
    ...
    config_section = Column(Enum(
        "lbaas_settings", "vapv_settings", "services_director_settings"
    ), nullable=False)
    ...
    def __repr__(self):
        return "<ArrayLbassTenantCustomizations %s: %s %s:%s=%s>" % (
